...
package com.ultimatepixel.ultimatepixeldungeon.ios;
...
public class IOSLauncher extends IOSApplication.Delegate {
	...
	protected IOSApplication createApplication() {
		...
		//this is mostly a copy-paste from IOSApplication.getPreferences
			...
			File finalPath = new File(libraryPath, UPDSettings.DEFAULT_PREFS_FILE + ".plist");
			...
			UPDSettings.set(new IOSPreferences(nsDictionary, finalPath.getAbsolutePath()));
		//end of prefs setup
		...
		config.hideHomeIndicator = UPDSettings.fullscreen();
		config.overrideRingerSwitch = UPDSettings.ignoreSilentMode();
		...
		return new IOSApplication(new UltimatePixelDungeon(new IOSPlatformSupport()), config);
	}

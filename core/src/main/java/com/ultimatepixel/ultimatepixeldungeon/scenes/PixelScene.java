...
import com.ultimatepixel.ultimatepixeldungeon.effects.BadgeBanner;
import com.ultimatepixel.ultimatepixeldungeon.ui.RenderedTextBlock;
import com.ultimatepixel.ultimatepixeldungeon.ui.Tooltip;
...
public class PixelScene extends Scene {
	...
	public void create() {
		...
		Game.platform.setupFontGenerators(renderedTextPageSize, UPDSettings.systemFont());
	...
	public void update() {
		...
		if (!Cursor.isCursorCaptured()) {
			if (Math.abs(ControllerHandler.rightStickPosition.x) >= 0.2f
				...
				int sensitivity = UPDSettings.controllerPointerSensitivity() * 100;
	...
	public static boolean landscape(){
		return UPDSettings.interfaceSize() > 0 || Game.width > Game.height;
	}

...
import com.ultimatepixel.ultimatepixeldungeon.actors.mobs.DemonSpawner;
import com.ultimatepixel.ultimatepixeldungeon.actors.mobs.Mob;
import com.ultimatepixel.ultimatepixeldungeon.actors.mobs.Snake;
...
import com.ultimatepixel.ultimatepixeldungeon.effects.EmoIcon;
import com.ultimatepixel.ultimatepixeldungeon.effects.Flare;
import com.ultimatepixel.ultimatepixeldungeon.effects.FloatingText;
import com.ultimatepixel.ultimatepixeldungeon.effects.Ripple;
import com.ultimatepixel.ultimatepixeldungeon.effects.SpellSprite;
import com.ultimatepixel.ultimatepixeldungeon.items.Ankh;
...
import com.ultimatepixel.ultimatepixeldungeon.items.journal.Guidebook;
...
import com.ultimatepixel.ultimatepixeldungeon.levels.RegularLevel;
import com.ultimatepixel.ultimatepixeldungeon.levels.rooms.Room;
import com.ultimatepixel.ultimatepixeldungeon.levels.rooms.secret.SecretRoom;
...
import com.ultimatepixel.ultimatepixeldungeon.sprites.DiscardedItemSprite;
...
import com.ultimatepixel.ultimatepixeldungeon.tiles.CustomTilemap;
import com.ultimatepixel.ultimatepixeldungeon.tiles.DungeonTerrainTilemap;
import com.ultimatepixel.ultimatepixeldungeon.tiles.DungeonTileSheet;
import com.ultimatepixel.ultimatepixeldungeon.tiles.DungeonTilemap;
import com.ultimatepixel.ultimatepixeldungeon.tiles.DungeonWallsTilemap;
import com.ultimatepixel.ultimatepixeldungeon.tiles.FogOfWar;
import com.ultimatepixel.ultimatepixeldungeon.tiles.GridTileMap;
import com.ultimatepixel.ultimatepixeldungeon.tiles.RaisedTerrainTilemap;
import com.ultimatepixel.ultimatepixeldungeon.tiles.TerrainFeaturesTilemap;
import com.ultimatepixel.ultimatepixeldungeon.tiles.WallBlockingTilemap;
import com.ultimatepixel.ultimatepixeldungeon.ui.ActionIndicator;
import com.ultimatepixel.ultimatepixeldungeon.ui.AttackIndicator;
import com.ultimatepixel.ultimatepixeldungeon.ui.Banner;
import com.ultimatepixel.ultimatepixeldungeon.ui.BossHealthBar;
import com.ultimatepixel.ultimatepixeldungeon.ui.CharHealthIndicator;
...
import com.ultimatepixel.ultimatepixeldungeon.ui.LootIndicator;
import com.ultimatepixel.ultimatepixeldungeon.ui.MenuPane;
import com.ultimatepixel.ultimatepixeldungeon.ui.QuickSlotButton;
import com.ultimatepixel.ultimatepixeldungeon.ui.ResumeIndicator;
import com.ultimatepixel.ultimatepixeldungeon.ui.RightClickMenu;
import com.ultimatepixel.ultimatepixeldungeon.ui.StatusPane;
import com.ultimatepixel.ultimatepixeldungeon.ui.StyledButton;
import com.ultimatepixel.ultimatepixeldungeon.ui.Tag;
import com.ultimatepixel.ultimatepixeldungeon.ui.TargetHealthIndicator;
import com.ultimatepixel.ultimatepixeldungeon.ui.Toast;
import com.ultimatepixel.ultimatepixeldungeon.ui.Toolbar;
...
import com.ultimatepixel.ultimatepixeldungeon.windows.WndGame;
import com.ultimatepixel.ultimatepixeldungeon.windows.WndHero;
import com.ultimatepixel.ultimatepixeldungeon.windows.WndInfoCell;
import com.ultimatepixel.ultimatepixeldungeon.windows.WndInfoItem;
import com.ultimatepixel.ultimatepixeldungeon.windows.WndInfoMob;
import com.ultimatepixel.ultimatepixeldungeon.windows.WndInfoPlant;
import com.ultimatepixel.ultimatepixeldungeon.windows.WndInfoTrap;
...
import com.ultimatepixel.ultimatepixeldungeon.windows.WndResurrect;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		UPDSettings.lastClass(Dungeon.hero.heroClass.ordinal());
		
		super.create();
		Camera.main.zoom( GameMath.gate(minZoom, defaultZoom + UPDSettings.zoom(), maxZoom));
		...
		int uiSize = UPDSettings.interfaceSize();
		...
		status = new StatusPane( UPDSettings.interfaceSize() > 0 );
	...
	public static void layoutTags() {
		...
		boolean tagsOnLeft = UPDSettings.flipTags();
		...
		float y = UPDSettings.interfaceSize() == 0 ? scene.toolbar.top()-2 : scene.status.top()-2;
		if (tagsOnLeft) {
		...
		if (tagsOnLeft && UPDSettings.interfaceSize() > 0){

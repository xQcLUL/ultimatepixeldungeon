...
import com.ultimatepixel.ultimatepixeldungeon.effects.ShadowBox;
...
public class Window extends Group implements Signal.Listener<KeyEvent> {
	...
	public static final int WHITE = Xml.getColor("pure_white");
	public static final int TITLE_COLOR = Xml.getColor("title_yellow");
	public static final int SHPX_COLOR = Xml.getColor("evan_green");
	public static final int UPX_COLOR = Xml.getColor("ultimate_purple");
	...
	public boolean onSignal( KeyEvent event ) {
		if (event.pressed) {
			if (KeyBindings.getActionForKey( event ) == UPDAction.BACK
				|| KeyBindings.getActionForKey( event ) == UPDAction.WAIT){
				onBackPressed();
			}
		}

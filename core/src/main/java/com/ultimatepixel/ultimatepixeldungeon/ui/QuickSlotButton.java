...
public class QuickSlotButton extends Button {
	...
	public GameAction keyAction() {
		switch (slotNum){
			case 0:
				return UPDAction.QUICKSLOT_1;
			case 1:
				return UPDAction.QUICKSLOT_2;
			case 2:
				return UPDAction.QUICKSLOT_3;
			case 3:
				return UPDAction.QUICKSLOT_4;
			case 4:
				return UPDAction.QUICKSLOT_5;
			case 5:
				return UPDAction.QUICKSLOT_6;
			default:
	...
	@Override
	public GameAction secondaryTooltipAction() {
		return UPDAction.QUICKSLOT_SELECTOR;
	}

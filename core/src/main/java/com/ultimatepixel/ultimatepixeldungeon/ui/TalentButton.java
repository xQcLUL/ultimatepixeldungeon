...
import com.ultimatepixel.ultimatepixeldungeon.items.scrolls.exotic.ScrollOfMetamorphosis;
...
import com.ultimatepixel.ultimatepixeldungeon.windows.WndInfoTalent;
...
public class TalentButton extends Button {
	...
	protected void onClick() {
		...
		if (UltimatePixelDungeon.scene() instanceof GameScene){
			...
			UltimatePixelDungeon.scene().addToFront(toAdd);
		}
	}

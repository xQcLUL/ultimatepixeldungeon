...
public class WndEnergizeItem extends WndInfoItem {
	...
	public static void energize( Item item ) {
		...
		if (UltimatePixelDungeon.scene() instanceof AlchemyScene){
			...
			((AlchemyScene) UltimatePixelDungeon.scene()).createEnergy();
	...
	public static WndBag openItemSelector(){
		if (UltimatePixelDungeon.scene() instanceof GameScene) {
			...
			UltimatePixelDungeon.scene().addToFront(window);
			return window;
		}
	}
		...
		public void onSelect(Item item) {
			if (item != null) {
				...
				if (UltimatePixelDungeon.scene() instanceof GameScene) {
					...
					UltimatePixelDungeon.scene().addToFront(new WndEnergizeItem(item, parentWnd));
				}
			}
		}
	};

...
import com.ultimatepixel.ultimatepixeldungeon.scenes.StartScene;
	...
	public WndGameInProgress(final int slot){
		...
		RedButton cont = new RedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				UltimatePixelDungeon.switchScene(InterlevelScene.class);
			}
		};
		...
		RedButton erase = new RedButton( Messages.get(this, "erase")){
			...
			protected void onClick() {
				...
				UltimatePixelDungeon.scene().add(new WndOptions(Icons.get(Icons.WARNING),

...
package com.ultimatepixel.ultimatepixeldungeon.levels.painters;
...
import com.ultimatepixel.ultimatepixeldungeon.levels.Patch;
		...
		for (Room n : r.connected.keySet()) {
			...
			if (door == null) {
				...
				if (doorSpots.isEmpty()){
					UltimatePixelDungeon.reportException(

...
import com.ultimatepixel.ultimatepixeldungeon.effects.particles.BloodParticle;
import com.ultimatepixel.ultimatepixeldungeon.effects.particles.CorrosionParticle;
...
import com.ultimatepixel.ultimatepixeldungeon.effects.particles.PurpleParticle;
...
public class MagicMissile extends Emitter {
	...
	public static class MagicParticle extends PixelParticle {
		...
		public MagicParticle() {
			...
			color(Xml.getColor("light_sky_blue"));
			lifespan = 0.5f;
	...
	public static class EarthParticle extends PixelParticle.Shrinking {
		...
		public void reset( float x, float y ) {
			...
			if (Random.Int(10) == 0){
				color(ColorMath.random(Xml.getColor("corn"), Xml.getColor("pesto")));
			} else {
				color(ColorMath.random(Xml.getColor("raw_umber"), Xml.getColor("black_magic")));
			}
	...
	public static class ShamanParticle extends EarthParticle{
		...
		public static final Emitter.Factory RED = new Factory() {
			...
			public void emit( Emitter emitter, int index, float x, float y ) {
				((ShamanParticle)emitter.recycle( ShamanParticle.class ))
						.reset( x, y, ColorMath.random(Xml.getColor("sunset_orange"), Xml.getColor("falu_red")) );
			}
		};
		...
		public static final Emitter.Factory BLUE = new Factory() {
			...
			public void emit( Emitter emitter, int index, float x, float y ) {
				((ShamanParticle)emitter.recycle( ShamanParticle.class ))
						.reset( x, y, ColorMath.random(Xml.getColor("cornflower_blue"), Xml.getColor("dark_cerulean")) );
			}
		};
		...
		public static final Emitter.Factory PURPLE = new Factory() {
			...
			public void emit( Emitter emitter, int index, float x, float y ) {
				((ShamanParticle)emitter.recycle( ShamanParticle.class ))
						.reset( x, y, ColorMath.random(Xml.getColor("electric_purple"), Xml.getColor("kingfisher_daisy_purple")) );
			}
		};
		...
		public void reset( float x, float y, int endColor ){
			...
			startColor = ColorMath.random(Xml.getColor("raw_umber"), Xml.getColor("black_magic"));
	...
	public static class ForceParticle extends PixelParticle.Shrinking {
		...
		public void reset( int index, float x, float y ) {
			super.reset( x, y, Xml.getColor("pure_white"), 8, 0.5f );
	...
	public static class WardParticle extends PixelParticle.Shrinking {
		...
		public WardParticle() {
			...
			color( Xml.getColor("blue_violet") );
		}

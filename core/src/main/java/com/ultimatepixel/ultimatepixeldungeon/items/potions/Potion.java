...
import com.ultimatepixel.ultimatepixeldungeon.items.potions.exotic.PotionOfCorrosiveGas;
import com.ultimatepixel.ultimatepixeldungeon.items.potions.exotic.PotionOfShroudingFog;
import com.ultimatepixel.ultimatepixeldungeon.items.potions.exotic.PotionOfSnapFreeze;
...
public class Potion extends Item {
	...
	protected int splashColor(){
		return anonymous ? Xml.getColor("deep_sky_blue") : ItemSprite.pick( image, 5, 9 );
	}

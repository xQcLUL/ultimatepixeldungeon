...
import com.ultimatepixel.ultimatepixeldungeon.plants.Plant.Seed;
...
public class Blandfruit extends Food {
	...
	public Item imbuePotion(Potion potion){
		...
		if (potionAttrib instanceof PotionOfHealing)        potionGlow = new ItemSprite.Glowing( Xml.getColor("lime_green"));
		if (potionAttrib instanceof PotionOfStrength)       potionGlow = new ItemSprite.Glowing( Xml.getColor("venetian_red") );
		if (potionAttrib instanceof PotionOfParalyticGas)   potionGlow = new ItemSprite.Glowing( Xml.getColor("tobacco_brown") );
		if (potionAttrib instanceof PotionOfInvisibility)   potionGlow = new ItemSprite.Glowing( Xml.getColor("gainsboro") );
		if (potionAttrib instanceof PotionOfLiquidFlame)    potionGlow = new ItemSprite.Glowing( Xml.getColor("dark_orange") );
		if (potionAttrib instanceof PotionOfFrost)          potionGlow = new ItemSprite.Glowing( Xml.getColor("maya_blue") );
		if (potionAttrib instanceof PotionOfMindVision)     potionGlow = new ItemSprite.Glowing( Xml.getColor("submarine") );
		if (potionAttrib instanceof PotionOfToxicGas)       potionGlow = new ItemSprite.Glowing( Xml.getColor("amethyst") );
		if (potionAttrib instanceof PotionOfLevitation)     potionGlow = new ItemSprite.Glowing( Xml.getColor("orient") );
		if (potionAttrib instanceof PotionOfPurity)         potionGlow = new ItemSprite.Glowing( Xml.getColor("fuchsia") );
		if (potionAttrib instanceof PotionOfExperience)     potionGlow = new ItemSprite.Glowing( Xml.getColor("eclipse") );
		if (potionAttrib instanceof PotionOfHaste)          potionGlow = new ItemSprite.Glowing( Xml.getColor("bird_flower") );

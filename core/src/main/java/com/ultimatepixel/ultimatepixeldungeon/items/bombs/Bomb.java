...
package com.ultimatepixel.ultimatepixeldungeon.items.bombs;
...
public class Bomb extends Item {
	...
	public ItemSprite.Glowing glowing() {
		return fuse != null ? new ItemSprite.Glowing(Xml.getColor("red"), 0.6f) : null;
	}
	...
	public static class DoubleBomb extends Bomb{
		...
		public boolean doPickUp(Hero hero, int pos) {
			...
			if (bomb.doPickUp(hero, pos)) {
				...
				if (UPDSettings.language() == Languages.ENGLISH)

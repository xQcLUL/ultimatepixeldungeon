...
import com.ultimatepixel.ultimatepixeldungeon.items.scrolls.exotic.ScrollOfPassage;
...
public class BeaconOfReturning extends Spell {
	...
	private static final ItemSprite.Glowing WHITE = new ItemSprite.Glowing(Xml.getColor("pure_white"));

...
import com.ultimatepixel.ultimatepixeldungeon.windows.WndCombo;
...
public class Combo extends Buff implements ActionIndicator.Action {
	...
	public void tintIcon(Image icon) {
		...
		if (move != null){
			icon.hardlight(move.tintColor & Xml.getColor("aqua"));
		} else {
			icon.resetColor();
		}
	}
	...
	public enum ComboMove {
		CLOBBER(2, Xml.getColor("magenta")),
		SLAM   (4, Xml.getColor("snuff_pink")),
		PARRY  (6, Xml.getColor("pure_white")),
		CRUSH  (8, Xml.getColor("cream")),
		FURY   (10, Xml.getColor("yellow"));

...
package com.ultimatepixel.ultimatepixeldungeon.actors.hero;
...
import com.ultimatepixel.ultimatepixeldungeon.actors.blobs.SacrificialFire;
...
import com.ultimatepixel.ultimatepixeldungeon.actors.buffs.AnkhInvulnerability;
import com.ultimatepixel.ultimatepixeldungeon.actors.buffs.AscensionChallenge;
import com.ultimatepixel.ultimatepixeldungeon.actors.buffs.Awareness;
...
import com.ultimatepixel.ultimatepixeldungeon.actors.buffs.HoldFast;
...
import com.ultimatepixel.ultimatepixeldungeon.actors.buffs.Regeneration;
...
import com.ultimatepixel.ultimatepixeldungeon.actors.mobs.Monk;
...
import com.ultimatepixel.ultimatepixeldungeon.items.Amulet;
import com.ultimatepixel.ultimatepixeldungeon.items.Ankh;
import com.ultimatepixel.ultimatepixeldungeon.items.Dewdrop;
...
import com.ultimatepixel.ultimatepixeldungeon.items.artifacts.CapeOfThorns;
...
import com.ultimatepixel.ultimatepixeldungeon.items.keys.CrystalKey;
import com.ultimatepixel.ultimatepixeldungeon.items.keys.GoldenKey;
import com.ultimatepixel.ultimatepixeldungeon.items.keys.IronKey;
import com.ultimatepixel.ultimatepixeldungeon.items.keys.Key;
import com.ultimatepixel.ultimatepixeldungeon.items.keys.SkeletonKey;
...
import com.ultimatepixel.ultimatepixeldungeon.levels.features.LevelTransition;
...
import com.ultimatepixel.ultimatepixeldungeon.scenes.InterlevelScene;
import com.ultimatepixel.ultimatepixeldungeon.scenes.SurfaceScene;
...
public class Hero extends Char {
	...
	private boolean actAlchemy( HeroAction.Alchemy action ) {
		...
		if (Dungeon.level.distance(dst, pos) <= 1) {
			...
			UltimatePixelDungeon.switchScene(AlchemyScene.class);
			return false;
	...
	public void die( Object cause ) {
		...
		if (ankh != null) {
			...
			if (ankh.isBlessed()) {
				...
				GameScene.flash(Xml.getColor("electric_blue"));
